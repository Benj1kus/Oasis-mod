    ...
    public static void tick(Level level, BlockPos pos, BlockState state, StatueBlockEntity entity) {
        ...
        if (entity.activeTicks > 0) {
            ...
            if (level instanceof ServerLevel serverLevel) {
                ...
                serverLevel.sendParticles(new BlockParticleOption(ParticleTypes.BLOCK, Blocks.SAND.defaultBlockState()), pos.getX() + 0.5D, pos.getY() + (height / 2.0D), pos.getZ() + 0.5D, 15, 0.4D, height / 2.0D, 0.4D, 0.05D);
            }
