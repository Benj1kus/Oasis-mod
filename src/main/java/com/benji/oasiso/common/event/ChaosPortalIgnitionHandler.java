...
public final class ChaosPortalIgnitionHandler {
    ...
    public static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (!clickedState.is(Oasiso.ENTROPY_BLOCK.get()) && !clickedState.is(Oasiso.KARAKOLIT_BLOCK.get())) {
            return;
        }

        Optional<ChaosPortalShape> foundShape = ChaosPortalShape.findIgnitableFrame(event.getLevel(), event.getPos());
        ...
        foundShape.get().createPortal(serverLevel);
