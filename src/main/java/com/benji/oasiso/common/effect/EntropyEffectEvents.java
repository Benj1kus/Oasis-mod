...
public final class EntropyEffectEvents {
    ...
    private static final String DAMAGE_LEVEL_TAG =
            Oasiso.MODID + ":entropy_damage_level";

    private static final String LAST_DAMAGE_TICK_TAG =
            Oasiso.MODID + ":entropy_last_damage_tick";
    ...
    public static void onLivingTick(LivingEvent.LivingTickEvent event) {
        ...
        long lastDamageTime =
                persistentData.getLong(LAST_DAMAGE_TICK_TAG);
        ...
        int nextDamage =
                persistentData.getInt(DAMAGE_LEVEL_TAG) + 1;
