...
public final class KarakFluidType extends FluidType {
    public KarakFluidType() {
        super(Properties.create()
                .descriptionId("fluid_type.oasiso.kr_water")
    ...
    public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
        consumer.accept(new IClientFluidTypeExtensions() {
            private final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath("oasiso", "block/kr_water");
            ...
            public Vector3f modifyFogColor(Camera camera, float partialTick, ClientLevel level,
                ...
                return new Vector3f(12 / 255.0F, 116 / 255.0F, 105 / 255.0F);
            }
