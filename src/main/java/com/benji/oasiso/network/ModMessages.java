...
public class ModMessages {
    ...
    public static void register() {
        ...
        INSTANCE = net;
        net.messageBuilder(SandScreenHitPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT).decoder(SandScreenHitPacket::new).encoder(SandScreenHitPacket::toBytes).consumerMainThread(SandScreenHitPacket::handle).add();
