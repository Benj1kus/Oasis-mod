...
public final class DialogueEditorClientHooks {
    ...
    public static final KeyMapping OPEN_EDITOR = new KeyMapping("key.oasiso.dialogue_editor", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_RIGHT_SHIFT, "key.categories.oasiso");
