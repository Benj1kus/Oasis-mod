...
final class DialogueJuiceSound {
    ...
    static void nodeHoverClick() {
        play(SoundEvents.WOODEN_BUTTON_CLICK_ON, 1.28F, 0.12F);
    }

    static void nodePressClick() {
