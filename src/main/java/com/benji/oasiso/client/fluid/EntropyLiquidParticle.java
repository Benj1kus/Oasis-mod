...
public final class EntropyLiquidParticle extends TextureSheetParticle {
    ...
    private EntropyLiquidParticle(ClientLevel level, double x, double y, double z, double rise, SpriteSet sprites, boolean steam) {
        super(level, x, y, z);
    ...
    public static final class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double vx, double vy, double vz) {
            ...
            EntropyLiquidParticle particle = new EntropyLiquidParticle(level, x, y, z, Math.max(0, Math.min(0.8, vy)), sprites, steam);
