...
import com.benji.oasiso.client.model.SpearAttackModel;
...
public class SpearAttackRenderer extends GeoEntityRenderer<SpearAttackEntity> {
    ...
    public SpearAttackRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new SpearAttackModel());
    ...
    public void render(SpearAttackEntity entity, float yaw, float partial, PoseStack pose,
        ...
        SpearAttackOutlinePass.draw(mesh, texture, minX, minY, maxX, maxY, crossesCamera, time, OUTLINE_OPACITY);
        mesh.clear();
    }
    ...
    @Override
    public boolean shouldRender(SpearAttackEntity entity, Frustum camera, double camX, double camY, double camZ) {
        return true;
    }
}
