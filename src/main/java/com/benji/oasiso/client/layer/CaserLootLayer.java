...
public class CaserLootLayer extends GeoRenderLayer<CaserEntity> {
    ...
    private static final List<Item> FAKE_ITEMS = List.of(Items.DIAMOND, Items.EMERALD, Items.GOLD_INGOT, Items.IRON_INGOT, Items.ROTTEN_FLESH, Items.NETHERITE_INGOT, Items.ENDER_PEARL, Items.STICK);
