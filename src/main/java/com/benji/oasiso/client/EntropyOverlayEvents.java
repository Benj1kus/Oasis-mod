...
public final class EntropyOverlayEvents {
    ...
    private static final ResourceLocation ENTROPY_OVERLAY =
            ResourceLocation.fromNamespaceAndPath(
                    Oasiso.MODID,
                    "textures/gui/entropy_overlay.png"
            );

    private static final ResourceLocation WHITE_OVERLAY =
            ResourceLocation.fromNamespaceAndPath(
                    Oasiso.MODID,
                    "textures/gui/white_overlay.png"
            );
    ...
    @SubscribeEvent
    public static void onRenderScreen(
    ...
    private static void renderOverlays(
        ...
        float scaleX =
                guiWidth / (float) TEXTURE_WIDTH;

        float scaleY =
                guiHeight / (float) TEXTURE_HEIGHT;
