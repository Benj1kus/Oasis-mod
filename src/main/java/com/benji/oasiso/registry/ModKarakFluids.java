...
public final class ModKarakFluids {
    ...
    public static final RegistryObject<FlowingFluid> KR_WATER = FLUIDS.register("kr_water", () -> new ForgeFlowingFluid.Source(properties()));
    public static final RegistryObject<FlowingFluid> FLOWING_KR_WATER = FLUIDS.register("flowing_kr_water", () -> new ForgeFlowingFluid.Flowing(properties()));
